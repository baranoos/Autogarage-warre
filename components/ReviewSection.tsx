...
export default function ReviewSection({ productId }: Props) {
  ...
  return (
    <div className="border-t border-gray-100 pt-10 mt-10">
      ...
      {user ? (
        !myReview || editingId ? (
          <form id="review-form" onSubmit={handleSubmit} className="bg-gray-50 rounded-xl p-5 mb-8 border border-gray-200">
            ...
            <textarea
              ...
              rows={3}
              className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:border-orange-500 resize-none mb-2"
            />
